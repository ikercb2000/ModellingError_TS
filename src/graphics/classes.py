...
from src.graphics.interfaces import ISimulationPlots
...
class PlotSimulatedTS(ISimulationPlots):
    ...
    def plot_sim_ts(self, ts_df: pd.DataFrame, errors: Optional[np.ndarray] = None, scatter_plot: bool = False, show_errors: bool = False, title: str = "Simulated Time Series"):
